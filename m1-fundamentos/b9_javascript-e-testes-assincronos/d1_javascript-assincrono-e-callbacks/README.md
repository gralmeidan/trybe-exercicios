...
Hoje nós aprendemos sobre o conceito de _callbacks_, o que são operações assíncronas em JavaScriptm como realizar testes assíncronos em _Jest_ e como utilizar `beforeEach` e `afterEach` em _Jest_ para realização de testes mais complexos.
