...
> Crie os arquivos script.js e script.spec.js

1. A função sum(a, b) retorna a soma do parâmetro a com o b
    1. Teste se o retorno de sum(4, 5) é 9
    1. Teste se o retorno de sum(0, 0) é 0
    1. Teste se a função sum lança um erro quando os parâmetros são 4 e "5" (string 5)
    1. Teste se a mensagem de erro é "parameters must be numbers" quando realizar a chamada sum(4, "5")
...
4. Para as funções encode e decode crie os seguintes testes em Jest:
    ...
    1. Para a função decode teste se os números 1, 2, 3, 4 e 5 são convertidos nas vogais a, e, i, o, u , respectivamente;
