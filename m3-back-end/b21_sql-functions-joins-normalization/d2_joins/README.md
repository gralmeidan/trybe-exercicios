# Bloco 21, Dia 2 - Descomplicando JOINs

Hoje nós aprendemos à juntar várias tabelas usando o `INNER JOIN`, `RIGHT JOIN` e `LEFT JOIN`, assim como aplicar funcionalidades de `JOIN` em uma única tabela com `SELF JOIN`.
